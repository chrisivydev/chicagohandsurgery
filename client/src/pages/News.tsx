            ...
            <Card className="bg-cssh-blue text-white">
              <CardContent className="p-8 md:p-12">
                <div className="max-w-4xl">
                  ...
                  <p className="text-xl text-blue-100 mb-6">We are now accepting abstract submissions for our 2024 Annual Spring Symposium. This year's theme focuses on "Innovation in Hand Surgery: Technology Meets Technique."</p>
                  <div className="flex flex-col sm:flex-row gap-4">
                    <Button className="bg-white text-cssh-blue hover:bg-gray-100">Submit Abstract</Button>
                    <Button variant="outline" className="border-2 border-white text-white hover:bg-white hover:text-cssh-blue">
                      Learn More
                    </Button>
                  </div>
                </div>
                  ...
                  <CardContent className="p-8">
                    <div className="flex items-start space-x-6">
                      <div className="flex-shrink-0">
                        <img src={article.image} alt={article.title} className="w-32 h-24 rounded-lg object-cover" />
                      </div>
                      <div className="flex-1">
                        ...
                        <a href="#" className="text-cssh-blue hover:underline font-medium">
                          Read More →
                        </a>
                      </div>
                    </div>
            ...
            <CardContent className="p-8">
              <div className="max-w-2xl mx-auto text-center">
                ...
                <form onSubmit={handleNewsletterSubmit} className="flex flex-col sm:flex-row gap-4 max-w-md mx-auto">
                  <Input type="email" placeholder="Enter your email address" value={email} onChange={(e) => setEmail(e.target.value)} required className="flex-1" />
                  <Button type="submit" disabled={newsletterMutation.isPending} className="bg-cssh-blue hover:bg-blue-700 whitespace-nowrap">
